...
#ifndef GRINS_PHYSICS_FACTORY_CONSERVATIVE_FLOW_H
#define GRINS_PHYSICS_FACTORY_CONSERVATIVE_FLOW_H
...
namespace GRINS
{
  ...
  class PhysicsFactoryConservativeFlow : public PhysicsFactoryWithCore
  {
  public:
    PhysicsFactoryConservativeFlow( const std::string& physics_name,
                                    const std::string& core_physics_name )
      : PhysicsFactoryWithCore(physics_name,core_physics_name)
    {}

    ~PhysicsFactoryConservativeFlow(){};
...
/* ---
    // -----------------------------------------------------------------------------------
    // Original Coding -- saved for future use?
    //       May be useful to use other viscosity models or as a primer for conductivity
    //       and specific heat?
    // -----------------------------------------------------------------------------------
...
--- */
  ...
  template<template<typename,typename,typename> class DerivedPhysics>
  inline
  void PhysicsFactoryConservativeFlow<DerivedPhysics>::prop_error_msg( const std::string& physics,
                                                                       const std::string& conductivity,
                                                                       const std::string& viscosity,
                                                                       const std::string& specific_heat ) const
  {
...
#endif // GRINS_PHYSICS_FACTORY_CONSERVATIVE_FLOW_H
